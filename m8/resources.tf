...
resource "aws_s3_bucket_object" "website" {
  ...
  # The output ".bucket" is exposed in the output.tf section of the module Module/s3 when it was defined. It exposes the bucket that was defined in that module and the refernece bucket.id used here is the id of the bucket. 
